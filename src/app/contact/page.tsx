              ...
              <form className="p-6 flex flex-col justify-center">
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    className="w-100 mt-2 py-3 px-3 rounded-lg bg-gray-300 border border-gray-400 text-gray-950 font-semibold  focus:outline-none"
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="md:w-32 bg-brandBlue bg-gray-300 hover:bg-gray-200 text-black font-bold py-3 px-6 rounded-lg mt-3  transition ease-in-out duration-300"
                >
                  Submit
                </button>
              </form>
